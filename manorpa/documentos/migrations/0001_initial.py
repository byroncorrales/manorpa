...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('documentos_archivo', (
            ...
            ('descripcion', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('adjunto', self.gf('manorpa.documentos.customfilefield.ContentTypeRestrictedFileField')(max_length=100)),
    ...
    models = {
        'documentos.archivo': {
            ...
            'adjunto': ('manorpa.documentos.customfilefield.ContentTypeRestrictedFileField', [], {'max_length': '100'}),
