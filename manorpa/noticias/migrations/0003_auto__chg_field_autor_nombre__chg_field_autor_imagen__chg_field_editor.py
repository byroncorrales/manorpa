...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Autor.nombre'
        db.alter_column('noticias_autor', 'nombre', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40))

        # Changing field 'Autor.imagen'
        db.alter_column('noticias_autor', 'imagen', self.gf('manorpa.noticias.thumbs.ImageWithThumbsField')(max_length=100, null=True))

        # Changing field 'Editorial.titulo'
        db.alter_column('noticias_editorial', 'titulo', self.gf('django.db.models.fields.CharField')(max_length=120, unique=True, null=True))


    def backwards(self, orm):
        
        # Changing field 'Autor.nombre'
        db.alter_column('noticias_autor', 'nombre', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40, null=True))

        # Changing field 'Autor.imagen'
        db.alter_column('noticias_autor', 'imagen', self.gf('manorpa.noticias.thumbs.ImageWithThumbsField')(max_length=100))

        # Changing field 'Editorial.titulo'
        db.alter_column('noticias_editorial', 'titulo', self.gf('django.db.models.fields.CharField')(max_length=120, unique=True))
