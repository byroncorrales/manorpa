...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('proyectos_financiador', (
            ...
            ('logo', self.gf('manorpa.proyectos.thumbs.ImageWithThumbsField')(max_length=100, null=True, blank=True)),
        ...
        db.create_table('proyectos_proyecto', (
            ...
            ('fecha_final', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
